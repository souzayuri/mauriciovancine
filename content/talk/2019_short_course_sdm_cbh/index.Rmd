...
summary: "Minicurso sobre a teórica e prática de Modelos Distribuição de Espécies utilizando a linguagem R"
...
- icon: images
  icon_pack: fas
  name: slides
  url: "slides/2019_minicurso_sdm_r_cbh.pdf"
- icon: gitlab
  icon_pack: fab
  name: material
