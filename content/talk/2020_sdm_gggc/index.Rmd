...
subtitle: 
draft: false
event: "Visita ao Laboratório (Grupo de Genética e Genômica da Conservação) da Profa. Maria Zucchi (USP/ESALQ)"
event_url: https://www.genomicadaconservacao.com.br/
location: Piracicaba, SP, Brazil
summary: "Uma visão geral e aplicações de Modelos de Distribuição de Espécies (SDMs)"
...
- icon: images
  icon_pack: fas
  name: slides
  url: "slides/2020_palestra_sdm_esalq.pdf"
